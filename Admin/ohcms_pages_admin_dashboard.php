      ...
      <div class="main-content container-fluid">
        <div class="row">
          <div class="col-12 col-lg-6 col-xl-3">
            ...
            <div class="widget widget-tile">
              ...
              <div class="data-info">
                <div class="desc">Para karyawan</div>
          ...
          <div class="col-12 col-lg-6 col-xl-3">
            ...
            <div class="widget widget-tile">
              ...
              <div class="data-info">
                <div class="desc">obat-obatan</div>
        ...
        <div class="row">
          <div class="col-12 col-lg-6">
            <div class="card card-table">
              <div class="card-header">
                <div class="title">Pembelian Farmasi</div>
              </div>
          ...
          <div class="col-12 col-lg-6">
            <div class="card card-table">
              <div class="card-header">
                <div class="title">Catatan Pasien Terbaru</div>
              </div>
              <div class="card-body table-responsive">
        ...
        <div class="row">
          <div class="col-12 col-lg-6">
            <div class="card card-table">
              <div class="card-header">
                <div class="title">Karyawan Departemen Senior</div>
              </div>
              <div class="card-body table-responsive">
                <table class="table table-striped table-borderless">
                  <thead>
                    <tr>
                      ...
                      <th style="width:20%;">Kepala Departemen</th>
                    </tr>
                  </thead>
                  <?php
