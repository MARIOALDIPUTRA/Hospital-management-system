          ...
          <div class="col-md-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Ruang isolasi</a></li>
                <li class="breadcrumb-item active" aria-current="page">Tambahkan Karyawan Ruang Isolasi</li>
              </ol>
            </nav>
            <div class="card card-border-color card-border-color-primary">
              <div class="card-header card-header-divider">Tambahkan Karyawan Isolasi Isolasi<span class="card-subtitle">Silakan isi detail yang diperlukan.</span></div>
              <div class="card-body">
                <?php if (isset($msg)) { ?>
                  <script>
                    setTimeout(function() {
