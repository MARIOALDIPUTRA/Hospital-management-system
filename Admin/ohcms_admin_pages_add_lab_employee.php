          ...
          <div class="col-md-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tambahkan Catatan Karyawan Laboratorium</li>
              </ol>
            </nav>
            <div class="card card-border-color card-border-color-primary">
              <div class="card-header card-header-divider">Tambahkan Karyawan Laboratorium<span class="card-subtitle">Silakan isi detail yang diperlukan.</span></div>
              <div class="card-body">
                <?php if (isset($msg)) { ?>
                  <script>
                    setTimeout(function() {
                ...
                <form method="POST">
                  ...
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Nomor Ponsel Karyawan</label>
                    <div class="col-12 col-sm-8 col-lg-6">
