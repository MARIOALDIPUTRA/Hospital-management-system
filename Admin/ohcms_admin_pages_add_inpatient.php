        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-border-color card-border-color-primary">
              <div class="card-header card-header-divider">Add InPatient Details<span class="card-subtitle">Silakan isi detail yang diperlukan.</span></div>
              <div class="card-body">
                <?php if (isset($msg)) { ?>
                  <script>
                    setTimeout(function() {
                ...
                <form method="POST">
                  ...
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Nama Belakang</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                  ...
                  <div class="col-sm-6">
                    <p class="text-right">
                      <button class="btn btn-space btn-primary" name="add_inpatient" type="submit">Daftar Pasien Rawat Inap</button>
