          ...
          <div class="col-md-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tambahkan Catatan Farmasi</li>
              </ol>
            </nav>
            <div class="card card-border-color card-border-color-primary">
              <div class="card-header card-header-divider">Tambahkan Rincian Farmasi (Obat)<span class="card-subtitle">Silakan isi detail yang diperlukan.</span></div>
              <div class="card-body">
                <?php if (isset($msg)) { ?>
                  <script>
                    setTimeout(function() {
                ...
                <form method="POST">
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Nama Farmasi</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" required name="pharm_name" type="text">
                    </div>
                  </div>
                  <div class="form-group row pt-1">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Kategori Farmasi/label>
                    <div class="col-12 col-sm-8 col-lg-6">
                  ...
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Kuantitas Farmasi (In Containers) </label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" required name="pharm_qty" type="text">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Farmasi Vendor</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                      <input class="form-control" id="inputText3" required name="pharm_vendor" type="text">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Tanggal Pembelian Farmasi</label>
                    <div class="col-12 col-sm-8 col-lg-6">
                  ...
                  <div class="form-group row">
                    <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Deskripsi Farmasi</label>
                    <div class="col-12 col-sm-8 col-lg-6">
