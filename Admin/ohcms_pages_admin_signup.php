 ...
 <head>
   ...
   <title>Orion HealthCare  Management System</title>
     ...
     <div class="be-content">
       <div class="main-content container-fluid">
         <div class="splash-container sign-up">
               ...
               <form method="post"><span class="splash-title pb-4">Sign Up</span>
                 ...
                 <div class="form-group pt-3 mb-3">
                   <div class="custom-control custom-checkbox">
                     ...
                     <label class="custom-control-label" for="check1">Dengan membuat akun, Anda menyetujui <a href="#">syarat dan Ketentuan</a>.</label>
                   </div>
                 </div>
           ...
           <div class="splash-footer">&copy; 2017-<?php echo date('Y'); ?> Orion HealthCare  Management System</div>
         </div>
       </div>
     </div>
   </div>
